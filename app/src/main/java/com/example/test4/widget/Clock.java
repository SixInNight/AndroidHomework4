package com.example.test4.widget;
...
public class Clock extends View {
    ...
    private void drawDegrees(Canvas canvas) {
        ...
        Paint mNumPaint = new Paint();
        mNumPaint.setTextSize(35);
        mNumPaint.setColor(Color.YELLOW);

        int rPadded = mCenterX - (int) (mWidth * 0.01f);
        int rEnd = mCenterX - (int) (mWidth * 0.05f);
        int rNum = mCenterX - (int) (mWidth * 0.09f);
        ...
        for (int i = 0; i < FULL_ANGLE; i += 6 /* Step */) {
            ...
            if ((i % RIGHT_ANGLE) != 0 && (i % 15) != 0)
                ...
                int mNumX = (int) (mCenterX + rNum * Math.cos(Math.toRadians(i)));
                int mNumY = (int) (mCenterX - rNum * Math.sin(Math.toRadians(i)));
                canvas.drawText(Integer.toString(i<90 ? (3 - i/30):(15 - i/30)), mNumX, mNumY, mNumPaint);
            }
